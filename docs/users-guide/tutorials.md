...
.为点位和路径定义和编辑车辆包络线
![](screenshot_envelope_editing.drawio.png)

.为车辆设置包络线键
![](screenshot_vehicle_envelope_key.drawio.png)
...
![](screenshot_layer_groups_panel.png)
...
.显示工厂模型的操作台应用程序
![](screenshot_operations_desk.png)
...
.操作台应用程序中的暂停和恢复按钮
![](screenshot_operations_desk_pause_and_resume.png)